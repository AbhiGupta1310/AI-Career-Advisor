...
class SkillsSchema(BaseModel):
    ...
    total_skills: str = Field(..., description="Comma-separated list of skills possessed")
...
class ProfileSchema(BaseModel):
    ...
    education_degree: str = Field(default=None, description="Highest education degree obtained")
    education_institution: str = Field(
        default=None,
        description="Institution from which the highest degree was obtained",
    )
    total_skills: str = Field(default=None, description="Comma-separated list of skills possessed")
